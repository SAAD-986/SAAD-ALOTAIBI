company = {
    "ceo": "Ahmed",
    "departments": {
        "engineering": {"manager": "Sara", "team_size": 12, "projects": ["Backend API", "Mobile App"]},
        "design": {"manager": "Omar", "team_size": 5, "projects": ["Website Redesign"]},
    },
}
...
total_size = company['departments']['engineering']['team_size'] + company['departments']['design']['team_size']
print(f"Total team size: {total_size}")
